    ...
    >
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className={`hidden sm:inline-block font-extrabold tracking-wide ${isDarkMode ? "text-white" : "text-gray-900"}`}>
                Gaming City
              </span>
            </button>
          </div>
            ...
            {LINKS.map((link) => (
              <button
                ...
                className={`relative cursor-pointer px-2 py-1 text-base font-medium transition-all duration-200
                  ${isDarkMode ? "text-gray-100 hover:text-yellow-400" : "text-gray-800 hover:text-yellow-500"}`}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a aria-label="youtube" href="#" className={`${isDarkMode ? "text-gray-200" : "text-gray-700"} hover:text-yellow-400 transition`}>
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M23.5 6.2s-.2-1.7-.8-2.5c-.8-.9-1.7-.9-2.1-1-2.9-.2-7.3-.2-7.3-.2s-4.4 0-7.3.2c-.4 0-1.4.1-2.1 1C.7 4.5.5 6.2.5 6.2S.2 8.6.2 11v1c0 2.4.3 4.8.3 4.8s.2 1.7.8 2.5c.8.9 1.9.8 2.4.9 1.7.1 7.2.2 7.2.2s4.4 0 7.3-.2c.4 0 1.4-.1 2.1-1 .6-.8.8-2.5.8-2.5s.3-2.4.3-4.8v-1c0-2.4-.3-4.8-.3-4.8zM9.5 15.6V8.4l6.3 3.6-6.3 3.6z"/></svg>
              </a>
              <a aria-label="instagram" href="#" className={`${isDarkMode ? "text-gray-200" : "text-gray-700"} hover:text-yellow-400 transition`}>
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor"><path d="M7 2h10a5 5 0 015 5v10a5 5 0 01-5 5H7a5 5 0 01-5-5V7a5 5 0 015-5zm5 5.9a4.1 4.1 0 100 8.2 4.1 4.1 0 000-8.2zM18.5 6a1.2 1.2 0 11-2.4 0 1.2 1.2 0 012.4 0z"/></svg>
              </a>
            </div>
            ...
            <button
              ...
              className={`hidden md:inline-flex items-center px-4 py-2 rounded-full font-semibold shadow-sm transition
                ${isDarkMode ? "bg-gradient-to-r from-yellow-600 to-yellow-400 text-gray-900" : "bg-gradient-to-r from-yellow-500 to-yellow-600 text-white"}`}
            >
              تسجيل الخروج
            </button>
      ...
      <div
        className={`md:hidden transform-gpu transition-all duration-250 origin-top
          ${isMobileOpen ? "max-h-[1000px] opacity-100" : "max-h-0 opacity-0 pointer-events-none"}`}
      >
        <div className={`px-4 pb-4 pt-2 ${isDarkMode ? "bg-gray-900" : "bg-white"}`}>
            ...
            {LINKS.map((link) => (
              <button
                ...
                className={`w-full text-right py-2 px-3 rounded-md font-medium transition
                  ${isDarkMode ? "text-gray-100 hover:bg-gray-800/60" : "text-gray-800 hover:bg-yellow-50"}`}
              >
                {link.label}
              </button>
            ))}

            <div className={`mt-2 border-t ${isDarkMode ? "border-gray-800" : "border-gray-200"}`} />
